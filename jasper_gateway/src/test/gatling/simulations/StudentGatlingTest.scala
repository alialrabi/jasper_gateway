...
class StudentGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Student entity")
        ...
        .repeat(2) {
            ...
            .get( "/jasper_microservice" + "/api/students")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new student")
            .post( "/jasper_microservice" + "/api/students")
            .headers(headers_http_authenticated)
            ...
            .repeat(5) {
                ...
                .get( "/jasper_microservice" + "${new_student_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created student")
            .delete( "/jasper_microservice" + "${new_student_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
