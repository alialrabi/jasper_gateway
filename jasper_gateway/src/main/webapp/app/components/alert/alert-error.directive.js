(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('jasperGatewayApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-jasperGatewayApp-error');
                var entityKey = httpResponse.headers('X-jasperGatewayApp-params');
                if (errorHeader) {
