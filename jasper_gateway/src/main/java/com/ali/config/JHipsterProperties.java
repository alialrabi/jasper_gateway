...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "jasper_gateway@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "jasper_gateway API";

        private String description = "jasper_gateway API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "jasper_gateway";
